...
import excepciones.IllegalParameterCotizacionException;
...
public class Logica {
    ...
    public Cotizacion crearCotizacion(LocalDate inicio, LocalDate fin, Alojamiento alojamiento) 
       throws IllegalParameterCotizacionException{
        
        if(inicio.isAfter(fin)){
            throw new IllegalParameterCotizacionException("Las fechas no son correctas");
        }
