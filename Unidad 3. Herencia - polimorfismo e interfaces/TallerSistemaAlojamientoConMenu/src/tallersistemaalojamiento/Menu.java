...
//            } while (this.opcionSeleccionada < 1 || this.opcionSeleccionada > 5);
    ...
    private void ejecutarOpcion1() {
        ...
        int tipo, noCuartos = 0, noPersonas = 0;
        do {
        ...
        switch (tipo) {
            case 1:
                ...
                noPersonas = this.lector.nextInt();
                alojamiento = new Habitacion(noPersonas, codigo, dir, ciudad, pais);
                break;
            case 2:
                System.out.printf("%-20s: ", "No cuartos");
                noCuartos = this.lector.nextInt();
                alojamiento = new Cabaña(noCuartos, codigo, dir, ciudad, pais);
                break;
        }
        ...
        if (confirmar == 1) {
            if (this.alojamientos.agregarAlojamiento(alojamiento)) {
    ...
    private void ejecutarOpcion2() {
        ...
        int codigo = this.lector.nextInt();
        Alojamiento alojamiento = this.alojamientos.buscar(codigo);
        if (alojamiento != null) {
            int dia, mes, anio;
            ...
            System.out.println("--------------------------");
            Cotizacion cotizacion = new Cotizacion(inicio, fin, alojamiento);
